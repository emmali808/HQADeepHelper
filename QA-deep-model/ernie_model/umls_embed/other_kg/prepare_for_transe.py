...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('raw kg text and save kg path config')
    parser.add_argument('--kg_in', required=True, help='the triple file path')
    parser.add_argument('--kg_out_dir', required=True, help='the kg prepared file out directory path')
    args = parser.parse_args()
    prepare_data(kg_in=args.kg_in, triple_out=args.kg_out_dir+'/triple2id.txt', relation_out=args.kg_out_dir+'/relation2id.txt', entity_out=args.kg_out_dir+'/entity2id.txt')
