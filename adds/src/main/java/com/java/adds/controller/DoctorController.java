...
//    String dataSetsPathInServer;
    ...
    @Value("HAR-master/data/pinfo/hqa_sample")
    String dataSetsPathInServer;
    ...
    {//类型包括train，test，dev
        ...
        try {
            ...
            // 文件保存路径（服务器用）
            String filePath=deepModelSamePath+dataSetsPathInServer+"data_"+dId.toString()+"/"+fileName;
    ...
    {
        //ArrayList<DataSetsEntity> dataSetsEntities=doctorService.getDataSets(doctorId);
