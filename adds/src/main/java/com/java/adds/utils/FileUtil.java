...
public class FileUtil {
    ...
    @Value("HAR-master/data/pinfo/config.py")
    ...
    {
        fileToBeChange=deepModelSamePath+fileToBeChange;
        try {
     ...
     *深度学习模型配置文件生成
     */
    public void createPythonConfig(String projectPath,String configPath, String configFile, DeepModelTaskEntity deepModelTaskEntity, DeepModelEntity deepModelEntity)
    {
        String config=configPath+configFile;
        String dataSetPath="";
        if(deepModelTaskEntity.getDatasetId()==1||deepModelTaskEntity.getDatasetId()==2)   //默认数据集
            ;
        else
            dataSetPath="/data_"+deepModelTaskEntity.getDatasetId().toString();
        System.out.println("configPath:"+config);
        try {
            File file =new File(config);
            if(!file.exists()){
                file.createNewFile();
            }
            FileWriter fileWritter = new FileWriter(configPath+file.getName());
            String modelName=deepModelMapper.getTaskNameById(deepModelTaskEntity.getModelId());
            System.out.println("modelName:"+modelName);
            BufferedWriter bufferWritter = new BufferedWriter(fileWritter);
            if(deepModelTaskEntity.getModelType()==1&&!(modelName.equals("PACRR")||modelName.equals("KNRM")||modelName.equals("DRMMTKS")))
            {
                bufferWritter.write("{\n"+
                        " \"srcdir\" : \""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\" ,\n"+
                        " \"dstdir\" : \""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\" ,\n"+
                        " \"traindir\" : \""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\" ,\n"+
                        " \"testdir\" : \""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\" ,\n"+
                        " \"devdir\" : \""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\" ,\n"+
                        " \"model_dst_dir\" : \""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\" ,\n"+
                        ...
                        " \"model_path\" : \""+projectPath+"HAR-master/matchzoo/models/\" ,\n"+
                        " \"weights_dir\" : \""+projectPath+"HAR-master/examples/pinfo/hqa_sample/\" ,\n"+
...
//                        "  \"inputs\": {\n" +
//                        "    \"share\": {\n" +
//                        "        \"text1_corpus\": \""+projectPath+"HAR-master/data/pinfo/hqa_sample" + dataSetPath + "/corpus_preprocessed.txt\",\n" +
//                        "        \"text2_corpus\": \""+projectPath+"HAR-master/data/pinfo/hqa_sample" + dataSetPath + "/corpus_preprocessed.txt\",\n" +
//                        "        \"use_dpool\": false,\n" +
//                        "        \"embed_size\": 300,\n" +
//                        "        \"embed_path\": \""+projectPath+"HAR-master/data/pinfo/hqa_sample" + dataSetPath + "/embed.idf\",\n" +
//                        "        \"vocab_size\": 19597,\n" +
//                        "        \"train_embed\": false,\n" +
//                        "        \"target_mode\": \"ranking\",\n" +
//                        "        \"bin_num\": 20,\n" +
...
//                        "        \"batch_per_iter\": 5,\n" +
//                        "        \"batch_size\": 100,\n" +
//                        "        \"relation_file\": \""+projectPath+"HAR-master/data/pinfo/hqa_sample" + dataSetPath + "/relation_train.txt\",\n" +
//                        "        \"hist_feats_file\": \""+projectPath+"HAR-master/data/pinfo/hqa_sample" +dataSetPath + "/relation_train.binsum-20.txt\"\n" +
//                        "    },\n" +
//                        "    \"valid\": {\n" +
//                        "        \"input_type\": \"DRMM_ListGenerator\",\n" +
//                        "        \"phase\": \"EVAL\",\n" +
//                        "        \"batch_list\": 10,\n" +
//                        "        \"relation_file\": \""+projectPath+"HAR-master/data/pinfo/hqa_sample" + dataSetPath + "/relation_valid.txt\",\n" +
//                        "        \"hist_feats_file\": \""+projectPath+"HAR-master/data/pinfo/hqa_sample" + dataSetPath + "/relation_valid.binsum-20.txt\"\n" +
//                        "    },\n" +
//                        "    \"test\": {\n" +
//                        "        \"input_type\": \"DRMM_ListGenerator\",\n" +
//                        "        \"phase\": \"EVAL\",\n" +
//                        "        \"batch_list\": 10,\n" +
//                        "        \"relation_file\": \""+projectPath+"HAR-master/data/pinfo/hqa_sample" + dataSetPath + "/relation_test.txt\",\n" +
//                        "        \"hist_feats_file\": \""+projectPath+"HAR-master/data/pinfo/hqa_sample" + dataSetPath + "/relation_test.binsum-20.txt\"\n" +
//                        "    },\n" +
//                        "    \"predict\": {\n" +
//                        "        \"input_type\": \"DRMM_ListGenerator\",\n" +
//                        "        \"phase\": \"PREDICT\",\n" +
...
//
            ...
            {
                bufferWritter.write("{\n"+
                    "    \"data_dir\" : \""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\" ,\n"+
                    " \"learning_rate\":0.001,\n"+
            ...
            else if(deepModelTaskEntity.getModelType()==1&&(modelName.equals("PACRR")||modelName.equals("KNRM")||modelName.equals("DRMMTKS")))
            {
                bufferWritter.write("{\n"+
                        " \"data_dir\" : \""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\" ,\n"+
                        " \"learning_rate\":0.001,\n"+
            ...
            else if(deepModelTaskEntity.getModelType()==3)
            {  bufferWritter.write("{\n"+
                        " \"data_dir\" : \""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\" ,\n"+
                        " \"redata_dir\" : \""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\",\n"+
                        " \"tok_ent_dir\":\""+projectPath+"HAR-master/data/pinfo/hqa_sample"+dataSetPath+"/\",\n"+
                        " \"text1_maxlen\": "+deepModelTaskEntity.getQueryLength()+",\n"+
                        " \"text2_maxlen\": "+deepModelTaskEntity.getDocumentLength()+",\n"+
                        " \"learning_rate\":0.001,\n"+
                        " \"MAX_EPOCH\":1,\n"+
                        ...
                        " \"atten_dim\": 200,\n"+
                        " \"base_metric\":\""+metricMapper.getMetricById(deepModelTaskEntity.getMetricId())+"\",\n"+
                        " \"entity_vec\": \""+projectPath+"ernie_model/kg_embed/entity2vec.vec\",\n"+
                        " \"model_out_dir\":\"all-weight/nf_drmmtks_glove_weight\",\n"+
                        " \"metrics\": [ \"ndcg@1\", \"ndcg@3\", \"ndcg@5\", \"ndcg@10\", \"map\", \"recall@3\", \"recall@3\", \"recall@5\", \"recall@10\", \"precision@1\", \"precision@3\", \"precision@5\", \"precision@10\"]\n"+ "}\n");
            ...
            else  //第四种
            {
                bufferWritter.write("{\n"+
                        ...
                        " \"atten_dim\": 200,\n"+
                        " \"entity_dim\": 100,\n"+
                        " \"kg_path\": \""+projectPath+"ernie_model/kg_embed\",\n"+
                        " \"content_entity\": \""+projectPath+"ernie_model/content2entity.f\",\n"+
                        " \"base_metric\":\""+metricMapper.getMetricById(deepModelTaskEntity.getMetricId())+"\",\n"+
                        " \"entity_vec\":\""+projectPath+"ernie_model/kg_embed/entity2vec.vec\",\n"+
                        " \"model_out_dir\":\"all-weight/nf_drmmtks_glove_weight\",\n"+
                        " \"metrics\": [ \"ndcg@1\", \"ndcg@3\", \"ndcg@5\", \"ndcg@10\", \"map\", \"recall@3\", \"recall@3\", \"recall@5\", \"recall@10\", \"precision@1\", \"precision@3\", \"precision@5\", \"precision@10\"]\n"+ "}\n");
    ...
    public Long extractResult(String outputPath,long taskId, Integer modelType,String modelName)
    {
        ...
        if(sc==null)
        {
            System.out.println("error: result file is empty");
        }
